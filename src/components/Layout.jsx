...
export function Layout({ children, onOpenFavorites, onOpenAbout, isDarkMode, toggleTheme }) {
    return (
        <div className="min-h-screen flex flex-col bg-[#FAFAF9] dark:bg-stone-950 text-stone-900 dark:text-stone-300 font-sans selection:bg-indigo-100 dark:selection:bg-indigo-900 selection:text-indigo-900 dark:selection:text-indigo-200 relative transition-colors duration-500 border-[12px] border-white dark:border-stone-800 box-border">
